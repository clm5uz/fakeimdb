<?php
	...
	$stmt = $db_connection->stmt_init();
        if($stmt->prepare("select media_id, title, year_released, genre from shared_with natural join media where receiving_user_id = ? ") or die(mysqli_error($db_connection))) {
